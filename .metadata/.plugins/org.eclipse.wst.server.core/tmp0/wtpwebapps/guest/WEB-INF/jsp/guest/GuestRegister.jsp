...
<%
 /**
  * @Class Name : GuestRegister.jsp
  * @Description : Guest Register 화면
...
<c:set var="registerFlag" value="${empty guestVO.idx ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="guestVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/guest/GuestList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/guest/deleteGuest.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/guest/addGuest.do' : '/guest/updateGuest.do'}"/>";
    frm.submit();
...
<form:form commandName="guestVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
